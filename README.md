    ...
    const ctx = gsap.context(() => {
      ...
      mm.add(
        ...
        (context) => {
          ...
          // Initial scale and border radius based on screen size
          gsap.set(videoRef.current, {
            scale: isLg ? 0.6 : 0.9,
            transformOrigin: "center center",
            borderRadius: isLg ? "60px" : isMd ? "40px" : "20px",
          });

          // Adjust scroll distance based on initial scale
          const scrollDistance = isLg ? 1500 : isMd ? 1200 : 800;
